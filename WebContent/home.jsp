    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
          			<li>
          			<form class='form-inline' action='searchItem.jsp' method='post'>
          				<input type='text' name='iname' class='form-control' placeholder='Search Any item'/>
			...
			<div class="carousel slide" id="screenshot-carousel" data-ride="carousel">
				...
				<ol class="carousel-indicators">
					...
					for(int x=0;x<count;x++){
						if(x==0){
						%>
						<li data-target="#screenshot-carousel" data-slide-to="<%=x %>" class="active"></li>
						<%		
						}else{
						%>
						<li data-target="#screenshot-carousel" data-slide-to="<%=x %>" ></li>
						<%	
						}
					}
					%>
				...
				<div class="carousel-inner">
					...
					for(int i:ids){
						...
						%>
						<img src="GetSlideImg?slide_id=<%=i%>" alt="Text of the image" height="10" width="1200">
   ...
   <!-- Modal forget password -->
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form action="ForgetPassword" method='post' data-toggle="validator"  role="form" class="form-horizontal">
                  <div class="form-group">
              <div class="col-lg-12">
