		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="slides.jsp"><span class="navfont">Slides</span></a></li>
				...
				<div class="row" style="margin:0 10px">
					...
					<div class="col-6 pull-right">
						...
						<form  action='UpdateOrderStatus' method='post'>
							...
							<input type='hidden' name='page' value='adminHome.jsp'/>
						...
						<form  action='UpdateOrderStatus' method='post'>
							<input type='hidden' name='order_id' value='<%=order_id%>'/>
							<input type='hidden' name='order_status' value='AcceptReturn'/>
							<input type='hidden' name='page' value='adminHome.jsp'/>
							<input type='submit' class="btn btn-success" value='AcceptReturn'/>
						</form>
						<form  action='UpdateOrderStatus' method='post'>
							<input type='hidden' name='order_id' value='<%=order_id%>'/>
							<input type='hidden' name='order_status' value='RejectReturn'/>
							<input type='hidden' name='page' value='adminHome.jsp'/>
							<input type='submit' class="btn btn-danger" value='RejectReturn'/>
						</form>
						<%} %>
